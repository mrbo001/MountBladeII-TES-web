...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MB-TES', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '骑马与砍杀 -- 上古卷轴|', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/mrbo001/MountBladeII-TES-DeityBefall', // 网站地址
